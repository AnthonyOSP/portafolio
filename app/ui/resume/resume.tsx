...
export default function resume() {
  return (
    <article className="resume active mb-3.5" data-page="resume">
        ...
        <section className="timeline mb-8">
          ...
          <div className="title-wrapper flex items-center gap-[15px] mb-[25px]">
            <div className="icon-box relative bg-gradient-to-br from-[#404040] from-10% to-[#40404000] to-50% w-[35px] h-[35px] rounded-[8px] flex justify-center items-center text-[16px] text-[#ffdb70] shadow-custom-shadow z-[1] ">
          ...
          <ol className="timeline-list text-[14px] ml-[45px]">
            ...
            <li className="timeline-item relative mb-[20px]">
              ...
              <span className='text-[#ceb15a] font-normal leading-relaxed'>2007 — 2008</span>
            ...
            <li className="timeline-item relative mb-[20px]">
              ...
              <span className='text-[#ceb15a] font-normal leading-relaxed'>2006 — 2007</span>
            ...
            <li className="timeline-item relative">
              ...
              <span className='text-[#ceb15a] font-normal leading-relaxed'>2002 — 2004</span>
        ...
        <section className="timeline mb-8">
          ...
          <ol className="timeline-list text-[14px] ml-[45px]">
            ...
            <li className="timeline-item relative mb-[20px]">
              ...
              <span className='text-[#ceb15a] font-normal leading-relaxed'>2015 — Present</span>
            ...
            <li className="timeline-item relative mb-[20px]">
              ...
              <span className='text-[#ceb15a] font-normal leading-relaxed'>2013 — 2015</span>
            ...
            <li className="timeline-item relative">
              ...
              <span className='text-[#ceb15a] font-normal leading-relaxed'>2010 — 2013</span>
        ...
        <section className="skill">
          ...
          <h3 className="h3 skills-title mb-5">My skills</h3>
