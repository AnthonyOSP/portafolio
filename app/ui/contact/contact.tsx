    ...
    return (
        <article className="contact active" data-page="contact">
            ...
            <section className="contact-form mb-2.5">
                ...
                <h3 className="h3 form-title mb-5">Contact Form</h3>

                <form action="#" className="form" data-form>

                    <div className="input-wrapper grid grid-cols-1 gap-[25px] mb-[25px] ">
                        <input type="text" name="fullname" className="form-input text-[#fafafa] text-[14px] font-normal py-[13px] px-5 border border-solid border-[#383838] rounded-[14px] outline-none placeholder:font-medium focus:border-[#ffdb70]" placeholder="Full name" required data-form-input />

                        <input type="email" name="email" className="form-input text-[#fafafa] text-[14px] font-normal py-[13px] px-5 border border-solid border-[#383838] rounded-[14px] outline-none placeholder:font-medium focus:border-[#ffdb70]" placeholder="Email address" required data-form-input />
                    </div>
