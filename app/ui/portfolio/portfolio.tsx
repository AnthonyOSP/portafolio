...
export default function portfolio() {
  const projects: Projects[] = [
    {
      image: "/images/project-1-avaquitectos.webp",
      title: "AVarquitectos",
      category: "Web development",
      link: "https://www.arturovallearquitectos.com/",
    },
    {
      image: "/images/project-2-alejandraburgos.webp",
      title: "AlejandraBurgos",
      category: "Web development",
      link: "https://alejandraburgos.netlify.app/",
    },
    {
      image: "/images/project-3-webhelp.webp",
      title: "Webhelp Tools",
      category: "Web design",
      link: "https://toolbose.netlify.app/",
    },
    {
              ...
              >
                <figure className="project-img relative w-full h-[200px] rounded-[16px] overflow-hidden mb-[15px] sm:rounded-[16px]">
                  ...
                  <img
                    ...
                    alt={projects.title}
                    loading="lazy"
                    className="w-full h-full object-cover transition ease duration-[250ms]"
                  />
                </figure>
                <h3 className="project-title ml-2.5 text-[#fafafa] text-[15px] font-normal capitalize leading-5">
                  {projects.title}
                </h3>
                <p className="project-category ml-2.5 text-[#d6d6d6b3] text-[14px] font-light">
                  {projects.category}
                </p>
              </a>
            </li>
